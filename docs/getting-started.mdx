...
There's no sign-in. A synthetic single-user identity, a personal organisation, and an initial project are auto-created on first launch and you're taken straight to the board.
