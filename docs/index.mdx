...
vibe-kanban-local is built for this. Use kanban issues to plan work on your local machine. When you're ready to begin, create workspaces where coding agents can execute.

This is a local-only fork of `BloopAI/vibe-kanban` — single-user, no cloud, no team features. Everything runs against a SQLite database in your home directory.
